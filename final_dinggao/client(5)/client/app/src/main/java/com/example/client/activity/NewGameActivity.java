...
public class NewGameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appUtil = (ApplicationUtil) NewGameActivity.this.getApplication();
                    ...
                    new Thread(new Runnable(){
                        ...
                        public void run() {
                            try {
                                ...
                                Intent i = new Intent(NewGameActivity.this, UserShowOneActivity.class);
                                Bundle b = new Bundle();
                    ...
                    new Thread(new Runnable(){
                        ...
                        public void run() {
                            try {
                                ...
                                Intent i = new Intent(NewGameActivity.this, ManageGameActivity.class);
                                Bundle b = new Bundle();
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_1: {   //主页
                    Intent i = new Intent(NewGameActivity.this, AudienceMainActivity.class);
                    Bundle b = new Bundle();
                ...
                case R.id.navigation_2: {   //直播
                    Intent intent = new Intent(NewGameActivity.this, BroadcastActivity.class);
                ...
                case R.id.navigation_4: {   //我的
                    Intent i = new Intent(NewGameActivity.this, MyActivity.class);
                    startActivity(i);
                    break;
                }
                default:{
