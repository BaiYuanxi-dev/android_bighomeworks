...
public class my1RVAdapterNew extends RecyclerView.Adapter<my1RVAdapterNew.MyTVHolder> {

    private final groupGame[] mArray;
    private final LayoutInflater mLayoutInflater;
    private final Context mContext;

    public my1RVAdapterNew(Context context, String mes) {
...
//                new groupGame("运输", "土建", "8","7","2021", "已结束", "决赛")};
    ...
    public MyTVHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MyTVHolder(mLayoutInflater.inflate(R.layout.cardviewitemnewnew, parent, false));
    }
