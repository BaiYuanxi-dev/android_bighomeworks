...
public class ManagerAllGameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manager_all_game);
        ...
        appUtil = (ApplicationUtil) ManagerAllGameActivity.this.getApplication();
                ...
                new Thread(new Runnable(){
                    ...
                    public void run() {
                        try {
                            ...
                            System.out.println(matchid + " " + feedback1);
                            Intent i = new Intent(ManagerAllGameActivity.this, ManageGameActivity.class);
                            Bundle b = new Bundle();
...
//
//                                Intent i = new Intent(ManagerAllGameActivity.this, UserShowOneActivity.class);
//                                Bundle b = new Bundle();
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_1: {   //主页
                    Intent i = new Intent(ManagerAllGameActivity.this, AudienceMainActivity.class);
                    Bundle b = new Bundle();
                ...
                case R.id.navigation_2: {   //直播
                    Intent intent = new Intent(ManagerAllGameActivity.this, BroadcastActivity.class);
                ...
                case R.id.navigation_4: {   //我的
                    Intent i = new Intent(ManagerAllGameActivity.this, MyActivity.class);
                    startActivity(i);
                    break;
                }
                default:{
